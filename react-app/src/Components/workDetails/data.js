export const data = [
  /*******************************************************************  ABI Thesis *******************************************************************/
  {
    id: "abi_thesis",
    title: {
      pt: "Sistema de Interoperabilidade ABI (Tese de Mestrado)",
      eng: "ABI Interoperability System (Master's Thesis)",
    },
    context: [
      {
        icon: "webdev",
    ...
    roles: [
      {
        pt: "",
        eng: "Paradigm Research",
      },
      {
        pt: "",
        eng: "Interoperability Engine Engine",
      },
      {
        pt: "",
        eng: "Databases Integration and Administration",
      },
      {
        pt: "",
        eng: "CRUD Design and Development",
      },
      {
        pt: "",
        eng: "Frontend Web Application",
      },
      {
        pt: "",
      ...
      {
        pt: "",
        eng: "Test Environment and tests",
      },
      {
        pt: "",
        eng: "Solution integration in real world scenario",
      },
    ],
    duration: {
      year: 2023,
    ...
    desc: [
      {
        eng: "The interoperability system I developed was designed to seamlessly connect diverse platforms, enabling efficient data exchange and communication between systems with varying architectures. Its modular design ensured flexibility, allowing for the integration of new components without disrupting existing workflows. By utilizing standardized communication protocols such as RESTful APIs and adopting universal data formats like JSON and XML, the system facilitated compatibility across different programming languages and frameworks.",
      },
      {
        eng: "A key feature of the system was its emphasis on scalability and security. The architecture was built to handle increasing volumes of data and expanding endpoints, ensuring reliable performance as the system grew. Security was woven into every layer, with advanced encryption techniques and robust authentication mechanisms safeguarding data integrity and user access. This ensured that interoperability did not come at the cost of system vulnerability.",
      },
      {
        eng: "To ensure reliability and minimize downtime, the system incorporated advanced monitoring and error-handling mechanisms. Automated logging and alert systems provided real-time insights into system health, while built-in error recovery protocols reduced the impact of potential failures. These features made the system highly dependable, even in high-demand environments.",
      },
      {
        eng: "The development process leveraged best practices like Continuous Integration and Continuous Deployment (CI/CD) to accelerate iterations and maintain code quality. Automated testing frameworks verified system performance across various scenarios, ensuring that each update preserved compatibility and functionality. This streamlined approach not only improved the development cycle but also reinforced the system’s resilience.",
      },
      {
        eng: "Overall, the interoperability system showcased a practical and scalable solution to modern integration challenges. By combining flexibility, security, and robust monitoring, it provided a solid foundation for enabling seamless interactions between diverse systems in complex environments.",
      },
    ],
    chall: [
      {
        eng: "Ensuring seamless communication between systems with differing architectures and protocols.",
      },
      {
        eng: "Handling data format inconsistencies and standardizing exchanges across platforms.",
      },
      {
        eng: "Balancing security measures with system performance and scalability.",
      },
      {
        eng: "Designing a modular architecture that allowed future integrations without disruptions",
      },
      {
        eng: "Debugging and resolving compatibility issues between heterogeneous components",
      },
      {
        eng: "Implementing robust error-handling mechanisms to maintain system reliability",
      },
      {
        eng: "Managing performance optimization for high data loads and concurrent users",
      },
      {
        eng: "Maintaining code quality and functionality during rapid iterations with CI/CD pipelines",
      },
    ],
    rate: 10,
    ratelabel: "Awesome solution and was awarded perfect marks 20/20",
    pos: [
      {
        eng: "Really fun project and concept",
      },
      {
        eng: "Allowed me to understand a lot about Healtcare IT",
      },
      {
        eng: "Allowed me to learn and work with new technologies",
      },
      {
        eng: "Helped me grow in technical skills and collaboration",
      },
    ],
    neg: [
      {
        eng: "Had little to no help while developing the solution",
      },
      {
        eng: "Mirth Connect is very challenging to work with",
      },
      {
        eng: "The problem was very broad and limitative",
      },
      {
        eng: "Had little time to develop everything",
      },
    ],
    img: [
      "abi_thesis1.png",
    ...
    git: "https://github.com/orgs/ABI-Interoperability-Thesis/repositories"
  },
  /*******************************************************************  Doppelganger *******************************************************************/
  {
    id: "doppelganger",
    ...
    roles: [
      ...
      {
        pt: "",
        eng: "Doppelganger CLI Design and Development",
      },
      {
        pt: "",
        eng: "Frontend Web Application",
    ...
    desc: [
      {
        eng: "As a SaST product Checkmarx's main product scans code bases and provides insights regarding the vulnerabilities found in them in the form of results. As expected, in order to test it, we have our own code bases dedicated only to be scanned over and over again.",
      },
      {
        eng: "This is, and has been, fine for a long time but as the pool of code bases grows it becomes increasingly slower and more expensive to conduct these kinds of tests. The premise for this project was that 'Among 500 different projects there has to be a few of them that are a little redundant.'.",
      },
      {
        eng: "So this project aims to reduce the number of duplicate projects/vulnerabilities that are taking up unnecessary space, time and resources on the CI processes and tests as well as make up space for new more interesting and rich code bases.",
      },
      {
        eng: "This was achieved by conducting various methods of node comparison using the results generated by SaST in each scan, thus asserting the siilarity between them. The calculation of result similarity is a process that takes into account numeorus factors such as node quantity and its type.",
      },
      {
        eng: "The compatison of results is done against and extensive database of scans and results metadata. The ammount size of available data for comparison ensures more accurate comparisons.",
      },
      {
        eng: "New scan sources are found through an automated process searching Github for new open-source projects or can also be manually uploaded and scanned.",
      },
    ],
    chall: [
      {
        eng: "As my first real enterprise project it was a bit hard to take in all the scope and remain on course in the beggining.",
      },
      {
        eng: "Researching methods for result comparison and similarity calculation was very challenging since there isn't a proven best way to do it.",
      },
      {
        eng: "I had to adapt and learn new technology I've never worked with",
      },
      {
        eng: "Working on multiple different projects/initiaves and making them all work together/maintaining them was and still is a little complicated.",
      },
    ],
    rate: 8,
    ratelabel: "Really enjoyed it",
    pos: [
      {
        eng: "Really fun project and concept",
      },
      {
        eng: "Allowed me to understand a lot Checkmarx's processes",
      },
      {
        eng: "Allowed me to learn and work with new technologies",
      },
    ...
    neg: [
      {
        eng: "There is no best way to calculate similarity so I was always doubting any value calculated",
      },
      {
        eng: "There were a lot of new technologies that were new to me so I has to adapt quickly",
      },
      {
        eng: "This was primarily my project so I worked alone a lot",
      },
    ],
    img: [
      "doppelganger1.png",
